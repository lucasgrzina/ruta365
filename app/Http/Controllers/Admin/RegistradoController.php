...
class RegistradoController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $data['filters']['retail_id'] = null;
        $data['filters']['sucursal_id'] = null;
    ...
    public function filter(Request $request)
    {
        try
        {
            ...
            $collection = $this->registradoRepository->with(['updater','sucursal.retail.pais'])->paginate($request->get('per_page'))->toArray();        
